...
void multiplyChunkOpenMP(const vector<int> &A_chunk, const vector<int> &B, vector<int> &C_chunk, int rowsPerProc) {
...
int main(int argc, char** argv) {
    ...
    multiplyChunkOpenMP(A_chunk, B, C_chunk, rowsPerProc);
    ...
    if (rank == 0) {
        cout << "MPI + OpenMP Execution Time: " << duration.count() << " ms" << endl;
    }
